...
daftarGejala = [
    "Gigi terasa ngilu",
    "Gigi terasa berdenyut",
    "Kepala terasa pusing",
    "Terdapat lubang pada gigi",
    "Gusi bengkak",
    "Demam (suhu badan diatas 38 derajat)",
    "Bau mulut",
    "Gusi berwarna merah tua",
    "Gusi rentan berdarah",
    "Adanya plak/karang gigi",
    "Mulut terasa kering",
    "Sering dehidrasi",
    "Lapisan lidah terasa tebal",
    "Cairan ludah berkurang",
    "Adanya benjolan putih/abu",
    "Terasa luka dan pedih",
    "Gigi terasa sakit",
    "Sakit saat mengunyah",
    "Gigi terasa sensitive",
    "Bentuk gigi tampak terkikis",
    "Gigi terasa nyeri saat makan/minum panas dan dingin",
    "Ngilu berkepanjangan (pada gigi)",
    "Gusi menurun",
    "Sakit setelah pencabutan gigi",
    "Sakit sampai kepala,telinga,mata,leher",
    "Gigi tidak sejajar",
    "Perubahan pada wajah",
    "Tidak nyaman ketika ngunyah dan menggigit",
    "Merasa tidak enak pada mulut",
    "Gigi longgar",
    "Lidah membesar",
    "Nyeri pada lidah",
    "Perubahaan warna pada lidah",
    "Permukaan ldah licin",
    "Warna permukaan lidah kemerahan",
    "Gigi terlihat jarang- jarang",
    "Gigi terlihat tonggos kedepan",
    "Ukuran gigi dan rahan tidak sesuai",
    "Adanya bercak pada sudut bibir",
    "Bercak terasa gatal nyeri dan panas pada bibir",
    "Bila di raba, bercak terasa keras pada bibir",
    "Kadang bercak juga bisa berdarah pada bibir",
    "Cadel",
    "Gigi sulung copot sebelum waktunya (prematur)",
]
daftarPenyakit = [
    "Karies gigi (gigi berlubang)",
    "Gingvitis (radang gusi)",
    "Lidah putih",
    "Stomatitis (sariawan)",
    "Abses gigi (gusi bengkak/nanah)",
    "Abrasi gigi (hilangnya struktur gigi)",
    "Gigi sensitive",
    "Alveolar osteitis (peradangan)",
    "Maloklusi (gigi berdesakan)",
    "Resesi gusi (penurunan gusi)",
    "Gloositis (radang lidah)",
    "Crowded (gigi berjejal)",
    "Cheilitis (radang bibir)",
]
solusiPenyakit = [
    "Tambal Gigi, Perawatan Saluran akar gigi, dan Cabut gigi",
    "Obat pereda nyeri,Obat kumur, dan Obat antibiotik",
    "Minum banyak air untuk membantu menghilangkan bakteri dan Menyikatnya dengan pembersih lidah khusu",
    "Pengobatan stomatitis aftosa,Pengobatan stomatitis herpes",
    "Perawatan saluran akar (root canal),Cabut gigi",
    "Pembuatan Mahkota Gigi (Crown),Penambalan Gigi",
    "Menggosok Gigi dengan benar,Hindari makanan dan minuman asam",
    "Pemberian obat kumur atau gel antibakteri segera sebelum dan sesudah operasi,Pemberian larutan antiseptik diberikan pada luka",
    "Pasang kawat gigi,Cabut gigi",
    "Perawatan dengan scaling dan root planning",
    "Menjaga kesehatan rongga mulut dengan cara menyikat gigi dua kali sehari (setelah sarapan dan sebelum tidur),Perubahan pola makan untuk mengatasi permasalahan nutrisi yang dapat menjadi penyebab terjadinya glositis",
    "Perawatan orthodonsi",
    "Salep anti jamur,Salep antibakteri",
]
gejala = 0
...
def welcome():
    if request.method == "POST":
        ...
        return render_template(
            "welcome.html", name=name, pertanyaan=pertanyaan, link=url_for("index")
        )
    ...
    if request.method == "POST":
        ...
        # =============================================================Logs 1
            ...
            if session["gejalaPasien"] == 0:  # Gejala 8
                ...
                terjangkitPenyakit = (
                    "Maaf Sistem kami belum bisa menjawab pertanyaan anda"
                )
                return render_template(
                    "result.html",
                    terjangkitPenyakit=terjangkitPenyakit,
...
def diagnosa():
    ...
    return render_template(
        "diagnosa.html", pertanyaan=pertanyaan, name=name, link=url_for("index")
    )
